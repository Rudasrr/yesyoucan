...
with sync_playwright() as p:
    ...
    # výběr ze seznamu s hledáním
    pg.evaluate("openCheatPicker()"); pg.wait_for_timeout(300)
    pg.fill('#chq', 'řízek'); pg.wait_for_timeout(250)
    print('hledání řízek najde:', pg.evaluate("document.querySelectorAll('.modal .pitem').length"))
    pg.evaluate("document.querySelector('.modal .pitem').click()"); pg.wait_for_timeout(300)
    pg.evaluate("openCheatPicker()"); pg.wait_for_timeout(250)
    pg.fill('#chq', 'hranolky'); pg.wait_for_timeout(250)
    pg.evaluate("document.querySelector('.modal .pitem').click()"); pg.wait_for_timeout(300)
    ...
    pg.evaluate("openCheatPicker()"); pg.wait_for_timeout(250)
    pg.fill('#chvl', 'něco divného'); pg.evaluate("window._chvl()"); pg.wait_for_timeout(250)
